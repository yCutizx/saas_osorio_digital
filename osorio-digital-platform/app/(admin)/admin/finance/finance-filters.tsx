...
export function FinanceFilters({ status, clientId, month, clients, months }: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <Select
        ...
        disabled={pending}
        options={[{ value: 'all', label: 'Todos os meses' }, ...months.map((m) => ({ value: m.value, label: m.label }))]}
      />
      {pending && (
