...
export default async function AdminPipelineIndexPage() {
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className="inline-flex items-center gap-2 px-3 py-2 rounded-xl border border-[#333] text-white/50 text-sm hover:text-white hover:border-[#555] transition-colors"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#EACE00] text-black text-sm font-semibold hover:bg-[#f5d800] transition-colors"
            >
        ...
        {(pipelines ?? []).length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4 bg-[#111] border border-[#222] rounded-2xl">
            ...
            <Link href="/admin/pipeline/new" className="text-[#EACE00] text-sm hover:underline">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {pipelines!.map((p) => (
              <Link
                ...
                className="group bg-[#0d0d0d] border border-[#222] rounded-2xl p-5 hover:border-[#333] transition-all"
              >
