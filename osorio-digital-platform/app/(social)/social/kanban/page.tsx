    ...
    <AppLayout pageTitle="Kanban de Conteúdo">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-white">Quadros de Conteúdo</h1>
            <p className="text-white/40 text-sm mt-0.5">Planejamento e produção de conteúdo</p>
          </div>
          <Link href="/social/kanban/new"
        ...
        {(!boards || boards.length === 0) ? (
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <Link href="/social/kanban/new" className="text-[#EACE00] text-sm hover:underline">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {boards.map((board) => {
              ...
              return (
                <Link key={board.id} href={`/social/kanban/${board.id}`}
