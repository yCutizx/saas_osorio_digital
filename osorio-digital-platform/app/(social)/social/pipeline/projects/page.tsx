...
import { ProjectsClient } from '@/app/(admin)/admin/pipeline/projects/projects-client'

export default async function SocialPipelineProjectsPage() {
    ...
    <AppLayout pageTitle="Projetos">
      <div className="space-y-6">
        ...
        <ProjectsClient
          ...
          projectsPageHref="/social/pipeline/projects"
        />
      </div>
    </AppLayout>
  )
