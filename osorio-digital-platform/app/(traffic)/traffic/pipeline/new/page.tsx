...
export default async function NewTrafficPipelinePage() {
  ...
  if (!profile || !ALLOWED.includes(profile.role)) redirect('/traffic/pipeline')
  ...
  return (
    <AppLayout pageTitle="Novo Pipeline">
      <div className="max-w-2xl">
        ...
        <NewPipelineForm staff={staff ?? []} currentUserId={user.id} cancelHref="/traffic/pipeline" successPathPrefix="/traffic/pipeline" />
      </div>
    </AppLayout>
  )
}
